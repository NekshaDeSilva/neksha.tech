    ...
    <div class="signIn-box">
        ...
        <div class="signIn-Box_inner signIn-6Box" style="align-items: center;" data-imp="TermsConditions_path">
            ...
            <div class="overlayDiv-tandcviewer_controlCpanel">
                <b>Copyright (c) 2025 NekshaDeSilva. All rights reserved by Indexx, inc.</b>.<br> All data entered will be encrypted and entirely managed by you in the future. We are not liable for any incidents resulting from your limited interaction or illegal use of data. Account statuses will be displayed approximately two to three weeks after account creation. In such cases, accounts containing illegal or abusive content will be automatically terminated, and all associated data and settings will be permanently erased, even if said accounts are verified on NCloud.<br> Data entered will be encrypted using cryptoAES, ensuring security until exposed to the public.<br>Your Accounts are always free to use, and any actions taken against the legal system of your country will be notified, with appropriate actions taken automatically.<br><b>NCloud PLC is a registered company in Sri Lanka.</b> For assistance, please contact us at hey@nekshavs.tech (temp.).
            </div>
